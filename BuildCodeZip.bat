...
%PATHPZIP% %REPO%\Core\ToDoList_Core.dsw /ZP %REPO%\..\ToDoList_Prev\8.0\ToDoList_src_Core.8.0._.zip /ML /NM

ECHO Zipping %REPO%\Plugins\ToDoList_Plugins.sln
%PATHPZIP% %REPO%\Plugins\ToDoList_Plugins.sln /ZP %REPO%\..\ToDoList_Prev\8.0\ToDoList_src_Plugins.8.0._.zip /ML /NM
